...
function set_dewater_head(tp) {
    $('head').html('<meta content="text/html; charset=utf-8" http-equiv="Content-Type">\n<title>' + tp + 
        '</title>\n<style>\n\
        body { background-color:#d3e2c8;font-size: large; font-family: Verdana; Arial, Helvetica, sans-serif,  text-indent: 2em; line-height: 160%; margin-left : 10px; margin-right: 10px }\n\
        .chapter,#dewater_title,#dewater_toc { font-size: 36px;font-family: 微软雅黑,宋体,黑体,楷体;line-height: 160%;margin-left: auto;margin-right: auto;padding-bottom: 15px; text-indent: 0em }\n\
